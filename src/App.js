...
class App extends Component {
	...
	constructor(props) {
		...
		this.newUser = {newUserName:"", newUserEmail:"", newUserNick:"", newUserRol:"", newUserPass:"", newUserRating: 0};
		this.state = {	
						user:"", 
						pass:"", 
						Logged: false, 
						...
						users : {
							...
							"123":{nick:"123", name:"123", rol:"Comprador", email:"123@gmail.com", rating:0,pass:"1234"},
							"1234":{nick:"1234", name:"1234", rol:"Vendedor", email:"1234@gmail.com", rating:0,pass:"1234"}
								},
						usersXemail: {
  ...
  render() {
	...
	*/
	handleUserNewName = (event) => {
		this.newUser["newUserName"] = event.target.value;
	}
	...
	*/
	handleUserNewEmail = (event) => {
		this.newUser["newUserEmail"] = event.target.value;
	}
	...
	*/
	handleUserNewNick = (event) => {
		this.newUser["newUserNick"] = event.target.value;
	}
	...
	*/
	handleUserNewRol = (event) => {
		this.newUser["newUserRol"] = event.target.value;
	}
	
	handleUserNewPass = (event) => {
		this.newUser["newUserPass"] = event.target.value;
	}
